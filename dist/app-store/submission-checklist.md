...
Canonical update-candidate values: iOS version `0.5.5`, build `50`, bundle ID
...
- [ ] Set the version to `0.5.5`, select build `50`, and leave Routing App Coverage
  empty.
...
- [ ] Confirm build `50` has finished processing and its export-compliance status is
  resolved.
