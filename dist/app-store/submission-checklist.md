...
Canonical update-candidate values: iOS version `0.5.5`, build `55`, bundle ID
...
- [ ] Set the version to `0.5.5`, select build `55`, and leave Routing App Coverage
  empty.
...
- [ ] Confirm build `55` has finished processing and its export-compliance status is
  resolved.
