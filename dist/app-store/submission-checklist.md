...
Canonical update-candidate values: iOS version `0.5.5`, build `56`, bundle ID
...
- [ ] Set the version to `0.5.5`, select build `56`, and leave Routing App Coverage
  empty.
...
- [ ] Confirm build `56` has finished processing and its export-compliance status is
  resolved.
