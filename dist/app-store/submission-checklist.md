...
Canonical update-candidate values: iOS version `0.5.5`, build `51`, bundle ID
...
- [ ] Set the version to `0.5.5`, select build `51`, and leave Routing App Coverage
  empty.
...
- [ ] Confirm build `51` has finished processing and its export-compliance status is
  resolved.
