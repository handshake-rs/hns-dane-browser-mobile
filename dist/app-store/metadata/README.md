...
Paste these public fields from `en-US/` into the `0.5.4` version record:
...
6. Complete every item in `../submission-checklist.md`, select build `48`, and choose manual release before adding the version for review.
