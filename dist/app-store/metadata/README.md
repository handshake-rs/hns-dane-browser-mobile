...
is `0.5.5` (build `49`). Build `48` is retained as predecessor upload evidence.
...
6. Complete every item in `../submission-checklist.md`, select build `49`, and choose manual release before adding the version for review.
