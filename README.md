...
- Implements DANE TLSA matching, bounded X.509 certificate SPKI extraction, chain-aware EE/TA TLSA policy, strict fail-closed HNS TLS decisions, and ordinary ICANN WebPKI decisions.
