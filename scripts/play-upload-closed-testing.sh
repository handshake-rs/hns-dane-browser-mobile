...
aab_path="${1:-dist/play-store/hns-dane-browser-v1.0.9-play-upload-signed.aab}"
release_name="${PLAY_RELEASE_NAME:-Shakescape 1.0.9}"
release_notes="${PLAY_RELEASE_NOTES:-1.0.9 refreshes name-proof timing after peer discovery to improve Handshake name import reliability in the native HNS wallet.}"
