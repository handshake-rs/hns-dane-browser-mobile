...
aab_path="${1:-dist/play-store/hns-dane-browser-v1.0.7-play-upload-signed.aab}"
release_name="${PLAY_RELEASE_NAME:-Shakescape 1.0.7}"
release_notes="${PLAY_RELEASE_NOTES:-1.0.7 publishes the coordinated wallet, peer-discovery, swap-recovery, and mobile browser fixes from exact audited Rust crates.}"
