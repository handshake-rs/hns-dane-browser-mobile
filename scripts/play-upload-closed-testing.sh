...
aab_path="${1:-dist/play-store/hns-dane-browser-v1.0.6-play-upload-signed.aab}"
release_name="${PLAY_RELEASE_NAME:-Shakescape 1.0.6}"
release_notes="${PLAY_RELEASE_NOTES:-1.0.6 aligns Android and iOS wallet, direct swap, lifecycle, and swap-status notification behavior.}"
