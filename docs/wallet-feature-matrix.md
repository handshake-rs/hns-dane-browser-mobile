...
| Direct-peer synchronization | Foreground service retains user-started scans and active swap monitoring within Android's data-sync budget | Protected foreground coordinator with durable resume after iOS suspension | Verified peer/header agreement, rollback floor, closed progress bundles, and stale-publication tests | Final installed-device interruption/resume and iPhone network qualification |
