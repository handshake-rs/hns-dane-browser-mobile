...
| `hns-wallet-rs` | `0.1.1` | tag commit `1c503f4aa1ed64c689b647c47605eb86b141d138` | [v0.1.1 release](https://github.com/handshake-rs/hns-wallet-rs/releases/tag/v0.1.1); all 14 public crates published and checksum/provenance verified |
...
at `=0.2.2` except the required `hns-browser-gateway` and
`hns-namespace-resolution` pins at `=0.2.3`, and `hns-wallet-ffi`, `hns-wallet-mobile`, and
`hns-wallet-types` at `=0.1.1`. The compatibility import names
