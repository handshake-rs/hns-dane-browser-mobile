...
| `hns-wallet-rs` | Git commit `b529820801b20c3d2956542433cbb046a4ecbe3a` | `Decouple HNS reads from Shakedex recovery` | all wallet entry crates and their transitive closure resolve from this one immutable source revision |
