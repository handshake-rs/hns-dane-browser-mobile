...
- Current source consumes the consolidated mobile engine adapters and canonical
  contracts from exact qualified engine `0.2.0` source
  `2b23bd55d14d36fe60073606869d75b4796c54f7`; the standalone facade is not a
  mobile input. All other Cargo Git inputs are limited to the exact reviewed
  wallet and transitive protocol revisions.
