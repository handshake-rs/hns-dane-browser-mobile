...
results predate the current `2061a27` pin/import tranche. Debug
...
| Native wallet candidate | HNWR-v2 prior gates passed; current exact-name import and product gates pending | Source links wallet `0.1.0` commit `2061a27e0358c7f00fcc70497ef97f9b89d569da`, with `hns-rs 0.3.0` closure `88ed7c64db52a6fcfce4146a8fc17b1377dfcc8e`, through a non-exported native activity, create-only Android KeyStore-wrapped database key, strict HNWR-v2 UI, and a native-only exact-text HNWI-v1 name-import control. Earlier HNWR-v2 source passed full CI `31807520618`; that evidence predates this import tranche. No wallet was created/restored and no credentialed operation ran. No scoped credential/indexed backend is provisioned, so reads and import are visibly unavailable; every provider/send/value/HNSA/HNSR/market path remains absent or gated. Play signing, installed-device qualification, fresh screenshots, and Console review/upload remain open. |
