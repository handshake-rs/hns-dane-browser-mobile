...
source coordinates Android `1.0.7` code `59`, embedded Rust `1.0.2`, and the
Apple `1.0.7` candidate at iOS build `69`. The preceding HNWR code-bearing source
