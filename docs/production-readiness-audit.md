...
non-publishable Rust `1.0.2`, and iOS `1.0.7` / build `69`. Both platform
...
| Area | Status | Finding |
| --- | --- | --- |
| Current source identity | Coordinated published dependency cohort; platform candidates independent | Android `1.0.7` / code `59`, iOS `1.0.7` / build `69`, and embedded Rust `1.0.2` use exact checksum-bearing HNS `0.4.2`, engine `0.2.5`, and wallet `0.2.4` releases. [released-dependency-cohort.md](released-dependency-cohort.md) binds that policy. |
...
| App Store update | `1.0.7` / build `69` prepared | The prior `1.0.6` / build `68` candidate is retained as release history. Current source, metadata, validation, and protected workflow guards target `1.0.7` / build `69`. Signing, exact-source Apple qualification, upload, metadata readback, and intentional submission remain open. The unapproved default-browser and MarketplaceKit app-installation entitlements remain absent. |
