...
Current source coordinates Android `1.0.8` / code `60`, embedded
non-publishable Rust `1.0.2`, and iOS `1.0.8` / build `71`. Both platform
...
| Area | Status | Finding |
| --- | --- | --- |
| Current source identity | Coordinated dependency cohort; platform candidates independent | Android `1.0.8` / code `60`, iOS `1.0.8` / build `71`, and embedded Rust `1.0.2` use exact HNS `0.4.2`, engine `0.2.5`, and wallet `0.2.6` releases. [released-dependency-cohort.md](released-dependency-cohort.md) binds that policy after registry publication. |
...
| App Store update | `1.0.8` / build `71` prepared | The recoverable `1.0.7` / build `70` artifact remains available separately. Current source, metadata, validation, and protected workflow guards target `1.0.8` / build `71`. Signing, exact-source Apple qualification, upload, metadata readback, and intentional submission remain open. The unapproved default-browser and MarketplaceKit app-installation entitlements remain absent. |
