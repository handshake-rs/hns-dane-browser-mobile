...
| Area | Status | Finding |
| --- | --- | --- |
| Current source identity | Coordinated published dependency cohort; platform candidates independent | Android `1.0.6` / code `58`, iOS `1.0.6` / build `68`, and embedded Rust `1.0.2` use exact checksum-bearing HNS `0.4.2`, engine `0.2.5`, and wallet `0.2.4` releases. [released-dependency-cohort.md](released-dependency-cohort.md) binds that policy. |
