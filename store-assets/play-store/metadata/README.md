...
This directory contains the candidate listing source for Android `1.0.5` / code
`57`, package `com.denuoweb.hnsdane`. Version numbers must be updated with the
...
- 1.0.5 release notes: `en-US/release-notes.txt`
...
- Expected upload artifact:
  `dist/play-store/hns-dane-browser-v1.0.5-play-upload-signed.aab`
