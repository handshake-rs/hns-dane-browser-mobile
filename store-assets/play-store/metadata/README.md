...
This directory contains the candidate listing source for Android `1.0.7` / code
`59`, package `com.denuoweb.hnsdane`. Version numbers must be updated with the
...
- 1.0.7 release notes: `en-US/release-notes.txt`
...
- Expected upload artifact:
  `dist/play-store/hns-dane-browser-v1.0.7-play-upload-signed.aab`
