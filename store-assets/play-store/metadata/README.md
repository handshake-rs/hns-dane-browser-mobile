...
This directory contains the candidate listing source for Android `1.0.9` / code
`61`, package `com.denuoweb.hnsdane`. Version numbers must be updated with the
...
- 1.0.9 release notes: `en-US/release-notes.txt`
...
- Expected upload artifact:
  `dist/play-store/hns-dane-browser-v1.0.9-play-upload-signed.aab`
