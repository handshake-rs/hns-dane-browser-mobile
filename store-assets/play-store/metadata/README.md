...
This directory contains the candidate listing source for Android `1.0.8` / code
`60`, package `com.denuoweb.hnsdane`. Version numbers must be updated with the
...
- 1.0.8 release notes: `en-US/release-notes.txt`
...
- Expected upload artifact:
  `dist/play-store/hns-dane-browser-v1.0.8-play-upload-signed.aab`
