...
class NativeBitcoinSyncProgressTest {
    ...
    fun parses_a_bounded_durable_swap_execution_projection() {
        ...
        assertNull(NativeBitcoinWalletBundle.shakescapeExecutions(bundle(
            """{"executions":[{"sessionId":"$sessionId","revision":7,"state":"peer_says_done","firstChain":"bitcoin","secondChain":"handshake","offeredAsset":"btc","offeredAmount":10000,"receivedAsset":"hns","receivedAmount":2000000,"localRole":"taker","firstRefundAtUnix":2000,"secondRefundAtUnix":1500,"firstFundingConfirmed":true,"secondFundingConfirmed":false,"firstRedemptionConfirmed":false,"secondRedemptionConfirmed":false,"refundConfirmed":false,"lastVerifiedAtUnix":1200,"failureReason":null}],"pendingAcceptances":[],"bitcoinBroadcastRecovery":null}""",
        )))
        assertNull(NativeBitcoinWalletBundle.shakescapeExecutions(bundle(
            """{"executions":[{"sessionId":"$sessionId","revision":7,"state":"first_funded","firstChain":"bitcoin","secondChain":"handshake","offeredAsset":"btc","offeredAmount":10000,"receivedAsset":"hns","receivedAmount":2000000,"localRole":"observer","firstRefundAtUnix":2000,"secondRefundAtUnix":1500,"firstFundingConfirmed":true,"secondFundingConfirmed":false,"firstRedemptionConfirmed":false,"secondRedemptionConfirmed":false,"refundConfirmed":false,"lastVerifiedAtUnix":1200,"failureReason":null}],"pendingAcceptances":[],"bitcoinBroadcastRecovery":null}""",
        )))
        assertNull(NativeBitcoinWalletBundle.shakescapeExecutions(bundle(
