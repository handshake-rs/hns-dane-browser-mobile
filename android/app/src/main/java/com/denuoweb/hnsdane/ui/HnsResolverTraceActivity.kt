...
class HnsResolverTraceActivity : ComponentActivity() {
    ...
    private fun friendlySummary(): String {
        ...
        return buildString {
            ...
            appendLine(getString(R.string.trace_field_local_chain_lag_blocks, nullableTraceValue(trace, "localChainLagBlocks")))
            appendLine(getString(R.string.trace_field_local_chain_freshness, trace.optString("localChainFreshness", getString(R.string.common_unknown))))
            appendLine(getString(R.string.trace_field_local_chain_target_source, trace.optString("localChainTargetSource", getString(R.string.common_unknown))))
            appendLine(getString(R.string.trace_field_local_chain_freshness_threshold, nullableTraceValue(trace, "localChainFreshnessThresholdBlocks")))
